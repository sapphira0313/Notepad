      ...
      <div className="px-3 py-2 border-b border-sidebar-border">
        <div className="relative">
          ...
          <input
            ...
            placeholder="搜索文档"
            className="w-full pl-9 pr-3 py-1.5 bg-background border border-border rounded-lg text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
          />
        </div>
      </div>
...
function TabButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 text-sm transition-colors ${
        active
